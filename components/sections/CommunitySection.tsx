        ...
        <FadeIn className="bg-brand-darkgreen rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-10 overflow-hidden relative">
          ...
          <div className="flex-1 text-center lg:text-left z-10">
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full mb-6 border border-white/20">
              <Sparkles className="w-4 h-4 text-brand-lightgreen" />
              <span className="text-brand-lightgreen text-sm font-semibold uppercase tracking-wider">
                Ecossistema da Nutri
              </span>
            </div>
            ...
            <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto lg:mx-0">
              Receba dicas diárias, receitas exclusivas, estratégias de nutrição comportamental e motivação para manter o foco no seu dia a dia, direto no seu celular.
            </p>

            <ul className="flex flex-col md:flex-row gap-4 md:gap-8 justify-center lg:justify-start mb-8 text-white/90">
              <li className="flex items-center gap-2">
                <div className="bg-brand-lightgreen/20 p-1.5 rounded-full">
                  <Users className="w-5 h-5 text-brand-lightgreen" />
                </div>
                <span>Comunidade Exclusiva</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="bg-brand-lightgreen/20 p-1.5 rounded-full">
                  <MessageCircle className="w-5 h-5 text-brand-lightgreen" />
                </div>
